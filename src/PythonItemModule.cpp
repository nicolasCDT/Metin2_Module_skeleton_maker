...
void initItem()
{
	...
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_SWORD_REDUCTION", CItemData::APPLY_RESIST_SWORD_REDUCTION);
	...
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_BELL_REDUCTION", CItemData::APPLY_RESIST_BELL_REDUCTION);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_FAN_REDUCTION", CItemData::APPLY_RESIST_FAN_REDUCTION);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_BOW_REDUCTION", CItemData::APPLY_RESIST_BOW_REDUCTION);
	...
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_CLAW_REDUCTION", CItemData::APPLY_RESIST_CLAW_REDUCTION);//APPLY_ATTBONUS_EARTH
#endif
#ifdef ENABLE_ACCE_COSTUME_SYSTEM
